...
pip install https://github.com/rlaope/jeval/releases/download/v0.1.5/jeval_cli-0.1.5-py3-none-any.whl
```
...
uvx --from git+https://github.com/rlaope/jeval@v0.1.5 jeval demo     # nothing installed, pinned
```
