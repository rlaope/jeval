...
[**One screen with the whole argument**](examples/demo-dashboard.html) is in this repository too —
for recording a demo, or for reading the case in one sitting: the line in use, the line the cost
minimum points at, both drawn and named on the same chart, and what moving it buys. It is built by
