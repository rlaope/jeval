...
description: Use when a classifier returns a confidence and nobody has checked what it is worth. Measures calibration from labeled records and names the confidence bands where the model is wrong about itself.
metadata:
  hermes:
